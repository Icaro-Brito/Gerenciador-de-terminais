...
Projeto focado em praticar JavaScript puro, manipulação de arquivos e boas práticas de interface.

## 🔧 Funcionalidades
- Upload de arquivos CSV ou TXT
- Conversão automática de separadores
- Extração de:
  - Número do terminal
  - Serial Number
...
## 🌐 Projeto online
🔗 https://gerenciadorterminais.tiiny.site

## 📁 Como usar
1. Faça upload de um arquivo CSV ou TXT
2. O sistema irá extrair automaticamente os dados
3. Utilize os botões para copiar os valores
